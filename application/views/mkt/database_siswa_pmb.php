			...
			<div class="page-header">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Database Siswa PMB</h4>
						...
						<div class="card">
							...
							<div class="card-body">
								<form action="" method="POST">
										...
										<div class="col-10">
											<select name="jurusan" class="form-control select-search" data-fouc>
												...
												<?php foreach($read_jurusan as $rj){
													$select="";
													if($rj->id==$jurusan){$select="selected";}
									...
									<div class="form-group row">
										<label class="col-form-label col-2">PRESENTER <span class="float-right">:</span></label>
										<div class="col-10">
											<select name="presenter" class="form-control select-search" data-fouc>
												<option value="">PILIH PRESENTER</option>
												<?php foreach($read_presenter as $rj){
													$select="";
													if($rj->kode_presenter==$presenter){$select="selected";}
													echo '<option '.$select.' value="'.$rj->kode_presenter.'">'.$rj->nama_presenter.'</option>';
												}?>
									...
									<table class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th width="100px" class="text-center">Presenter</th>
											</tr>
										</thead>
										<tbody>
											<?php 
											...
											<tr>
												...
												<td class="text-center">'.$d->nama_presenter.'</td>
											</tr>';
											}
											?>
										</tbody>
