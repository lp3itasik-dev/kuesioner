			...
			<div class="page-header">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Beasiswa</h4>
										...
										<div class="col-10">
											<select name="sekolah" class="form-control select-search" data-fouc>
												...
												<?php foreach($read_sekolah as $rs){
													$select="";
													if($rs->nama==$sekolah){$select="selected";}
										...
										<div class="col-10">
											<select name="jurusan" class="form-control select-search" data-fouc>
												...
												<?php foreach($read_jurusan as $rj){
													$select="";
													if($rs->nama==$jurusan){$select="selected";}
													echo '<option '.$select.' value="'.$rj->nama.'">[ '.$rj->kelas.' ] '.$rj->nama.'</option>';
												}?>
											</select>
										</div>
									</div>
									...
									<table class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th width="150px" class="text-center">Asal Sekolah</th>
												<th width="50px" class="text-center">Kelas</th>
												<th width="100px" class="text-center">NO HP</th>
												<th width="100px" class="text-center">Nama Ortu</th>
												<th width="100px" class="text-center">Pekerjaan Ortu</th>
												<th width="500px" class="text-center" style="min-width:300px!important">Prestasi</th>
										...
										<tbody>
											...
											<tr>
												...
												<td>'.$d->nama_ortu.'</td>
												<td>'.$d->pekerjaan_ortu.'</td>
												<td width="300px">'.$d->prestasi.'</td>
