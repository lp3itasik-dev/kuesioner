...
$header = array(
    array('NAMA PRESENTER','NAMA','TANGGAL LAHIR','ALAMAT','KABUPATEN/ KOTA','ASAL SEKOLAH','JURUSAN SEKOLAH','KELAS','RANKING','PRESTASI','NO HP/ WHATSAPP', 'NAMA ORANG TUA', 'PEKERJAAN ORANG TUA', 'NO HP ORANG TUA', 'PENGHASILAN ORANG TUA', 'LP3I', 'JURUSAN LP3I', 'KAMPUS LAIN', 'NAMA KAMPUS LAIN', 'JURUSAN KAMPUS LAIN', 'LAIN - LAIN', 'KIP', 'KESAN/ PERTANYAAN'),
);
