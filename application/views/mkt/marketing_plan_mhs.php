...
<body>
							...
							<div class="card-body">
								<form action="" method="POST">
									<div class="form-group row">
										...
										<div class="col-10">
											<select name="nama_prodi" class="form-control select-search sekolah" data-fouc data-combo="sekolah" required>
									...
									<table class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th class="text-center" width="200px">Nama Prodi</th>
	...
	<script>		
		function anggota(id){
		    ...
		    $('.modal-body').load('<?= base_url() ?>mkt/detail_marketing_plan_mhs/'+id);
		}
	</script>
</body>
